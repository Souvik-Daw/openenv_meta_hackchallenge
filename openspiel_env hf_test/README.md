...
base_path: /web
tags:
  - temp/env-builds-with-mcp-fix
  - openenv-temp/env-builds-with-mcp-fix
  - openenv
---

## Hugging Face Space Deployment

This Space is built from OpenEnv environment `openspiel_env`.

- Space URL: `https://huggingface.co/spaces/mroyme/openspiel_env`
- OpenEnv pinned ref: `temp/env-builds-with-mcp-fix`
- Hub tag: `temp/env-builds-with-mcp-fix`
...
env = OpenSpielEnv(base_url="https://huggingface.co/spaces/mroyme/openspiel_env")
```
